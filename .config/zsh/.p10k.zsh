# Generated by Powerlevel10k configuration wizard on 2023-04-20 at 23:00 UTC.
...
# 2 lines, dotted, white-ornaments, sparse, concise, instant_prompt=quiet.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_DIR_PREFIX='%B%F{green}%n@%m%f%b:'
